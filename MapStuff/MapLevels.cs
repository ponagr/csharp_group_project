...
public static class AddMaps     //Innehåller alla färdiga maplevels
{
    ...
    public static Map Level1() // Första banan med chars som bygger upp väggar, fiender osv.
    {
        ...
        new TWeapon("Legolas Pilbåge", 6, 4, 5, 10, 1),
    ...
    public static Map Level3()
    {
        ...
        new Consumable(),
        new THelm("Greatest Plåthjälm", 10, 25, 20, 0, 7),
        new THelm("Balaclava", 5, 12, 10, 30, 6),
        new TWeapon("Bra pinne", 25, 5, 0, 10, 6),
        new TWeapon("Stock", 30, 10, 5, 0, 7),
        new TBoots("Buffalos", 0, 24, 15, 10, 6),
        new TBoots("Bagheera", 0, 22, 10, 30, 6),
        new TGloves("Knogjärn", 20, 5, 5, 10, 7),
        new TBreastPlate("Canada Goose", 10, 25, 25, 0, 6)};
