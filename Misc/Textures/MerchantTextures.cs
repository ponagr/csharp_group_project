public static partial class Textures
{
    ...
    public static void PrintMerchantAgain() // Vore fett om man hade en funktion som satte en kort sleep mellan varje char så att texten "skrivs ut" när man kommer in i printmetoden
    {
        Console.Clear();
        Console.ForegroundColor = ConsoleColor.DarkGray;
        Console.SetCursorPosition(15, 4);
        ...
        Console.ForegroundColor = ConsoleColor.Blue;
        Console.SetCursorPosition(23, 10);
        Write.OneLetterAtATime("Merchant: Welcome back!");
        Thread.Sleep(700);
        Console.ResetColor();
    }
}